(function () {
  ...
  const recipe = {
    id: 27,
    title: "Acai Bowl",
    description: "A refreshing and nutritious acai bowl topped with fresh berries, banana and peanut butter. Perfect for a healthy breakfast or snack.",
    category: "breakfast",
    ...
    references: [],
    ingredients: [
      { amount: 1, unit: 'packet', rest: 'frozen acai puree' },
      ...
      { amount: 2, unit: 'tsp', rest: 'peanut butter', note: 'for topping' },
