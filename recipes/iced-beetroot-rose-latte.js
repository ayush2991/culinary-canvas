(function () {
  ...
  const recipe = {
    ...
    category: "beverage",
    tags: ["dairy-free", "caffeine-free", "vegan"],
    time: "5 min",
    servings: "1",
    difficulty: "Easy",
    ...
    ingredients: [
      ...
      { amount: null, unit: '', rest: 'cacao nibs', note: 'for garnish' },
    ...
    instructions: [
      ...
      "Add your cacao nibs and rose petals right on top of the ice so they stay afloat for that perfect photo look.",
    ]
  };
