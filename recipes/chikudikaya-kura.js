(function(){
    ...
    const recipe = {
        ...
        ingredients: [
            "1 lb (about 450 g) cluster beans (Chikudikaya), trimmed and cut into 1–2 inch pieces",
            "Enough water to cover the beans in the pressure cooker",
            "1/2 tsp salt (for cooking beans)",
            "2 tbsp cooking oil (sesame or vegetable)",
            "1 tsp mustard seeds",
            "1 tsp cumin seeds",
            "1 tsp urad dal (split black gram)",
            "2–3 dry red chilies (broken), adjust to taste",
            "1 tsp fresh ginger, grated (optional)",
            "1 medium onion, finely chopped",
            "1 medium tomato, finely diced",
            "1/2 tsp turmeric powder",
            "1 tsp red chili powder (adjust to taste)",
            "To taste salt (additional)",
