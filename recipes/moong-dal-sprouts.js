(function () {
  const recipe = {
    ...
    description: "A refreshing sprouted mung bean salad packed with fresh veggies, crunchy peanuts, and tangy spices.",
    category: "appetizer",
    ...
    ingredients: [
      ...
      { amount: 2 / 3, unit: 'tsp', rest: 'Red Chili' },
      { amount: 2 / 3, unit: 'tsp', rest: 'Coriander Powder' },
      { amount: 1 / 2, unit: 'tsp', rest: 'Garam Masala' },
      { amount: 2, unit: 'tbsp', rest: 'Onion', note: 'finely chopped' },
      { amount: 0.25, unit: 'medium', rest: 'Tomato', note: 'chopped' },
      { amount: 1 / 3, unit: 'cup', rest: 'Lemon Juice' },
      { amount: 1, unit: 'handful', rest: 'Roasted Peanuts', note: 'for topping' },
